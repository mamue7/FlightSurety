...
contract FlightSuretyData {
    ...
    */
    ...
    {
        require(msg.sender == contractOwner, "Caller isn't contract owner");
        _;
    }
    ...
    */
    ...
    {
        require(flights[flightIdentifier].isRegistered , "Flight not registered");
        _;
    }
    ...
    */
    modifier requiredNotProcessesForPayment(bytes32 flightIdentifier) {
        require(flights[flightIdentifier].statusCode == 0, "The flight has already been processed for payment");
        _;
    }
