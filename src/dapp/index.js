...
(async () => {
  ...
  let contract = new Contract('localhost', () => {
    ...
    contract.isOperational((error, result) => {
      display('Contract Status', 'Check if contract is operational', [{ label: 'Contract Status', error: error, value: result }])
    });

    contract.isAuthorizedCaller((error,result) => {
      display('Authorization Status', 'Check if contract is Authorized', [{label: 'Authorizarion Status', error: error, value: result }])
    });
